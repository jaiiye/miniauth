...
public class OAuthIncomingRequestBuilderTest
{
    ...
    public void testBuild()
    {
        try {
            ...
            String queryString = "a=b&c=d%33e";
            
            OAuthIncomingRequestBuilder oauthIncomingRequestBuilder = new OAuthIncomingRequestBuilder();
            OAuthIncomingRequest incomingRequest = oauthIncomingRequestBuilder.init().setHttpMethod(httpMethod).setBaseURI(baseUri).setAuthHeader(authHeader).setQueryParams(queryString).build();
